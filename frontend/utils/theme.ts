const CSSVariables = {
  ...
  colorMonopolyBg: '--color-monopoly-bg',
  colorPropertyYellow: '--color-property-yellow',
  colorPropertyRed: '--color-property-red',
  colorPropertySkyblue: '--color-property-skyblue',
  colorPropertyBrown: '--color-property-brown',
  colorPropertyOrange: '--color-property-orange',
  colorPropertyGreen: '--color-property-green',
  colorPropertyPink: '--color-property-pink',
  colorPropertyBlue: '--color-property-blue',
  colorChanceBlue: '--color-chance-blue',
  colorChanceOrange: '--color-chance-orange',
  colorChancePink: '--color-chance-pink',
  colorTax: '--color-tax',
...
export default {
  ...
  typography: {
    ...
    small: { size: '0.675em', weight: 'normal' },
  },
};
